    ...
    <body>
        ...
        <header id="header">
            <div class="d-flex flex-column">
                ...
                <nav class="nav-menu">
                    <ul>
                        <li class="active">
                            <a href="/"><i class="text-light fa fa-home" aria-hidden="true">
                        ...
                        <li>
                            <a href="#resume"><i class="text-light fa fa-database"
        ...
        <div id="main">
            <section id="hero" class="d-flex flex-column justify-content-center align-items-center">
                ...
                <h2 class="text-dark">
                    Complejo Sur
                    <span class="typed" data-typed-items="Usa tapabocas,Lava tus manos, Quedate en casa"></span>
                </h2>
            </section>
            <!-- End Hero -->
